...
class Notifyurl
{
    ...
    public function NotifyUrl()
    {
        ...
        $arr=$_POST;
        error_log(var_export($arr,1),3,"/data/wwwroot/mini3.pinecc.cn/runtime/test.txt");
    ...
    */
        ...
        if($result) {//验证成功
            ...
            //    error_log("开始进入afterpay".json_encode($arr),3,"/data/wwwroot/mini3.pinecc.cn/runtime/test.txt");
                $this->afterPay($arr);
