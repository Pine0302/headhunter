...
class Date
{
    ...
    public function getDateRate($createtime,$timeline,$now){
        $total_days = round(($timeline-$createtime)/self::DAY);
        $pass_days = ceil(($now-$createtime)/self::DAY);
        return $pass_days."/".$total_days;
    }
