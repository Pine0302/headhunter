 ...
 * @method mixed selectConfig(string $name, array $list = array(), string $selected = null, array $options = array()) static 表单textarea config
...
class FormBuilder
{
     ...
     * @return string
     */
    public function selectConfig($name, $list = array(), $selected = null, $options = array())
    {
        // When building a select box the "value" attribute is really the selected one
        // so we will use that when checking the model or session for a value which
        // should provide a convenient method of re-populating the forms on post.
