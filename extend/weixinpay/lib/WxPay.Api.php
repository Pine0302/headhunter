...
class WxPayApi
{
	...
	public static function report($inputObj, $timeOut = 1)
	{
		...
		$startTimeStamp = self::getMillisecond();//请求开始时间
		$response = self::postXmlCurl($xml, $url, false, $timeOut);
        error_log((var_export($response,1)),3,'/data/wwwroot/mini3.pinecc.cn/public/log/test.txt');
		return $response;
	}
	...
	{		
		...
		if($useCert == true){
			...
			//curl_setopt($ch,CURLOPT_SSLCERT, "/data/wwwroot/mini3.pinecc.cn/extend/weixinpay/cert/");
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			//curl_setopt($ch,CURLOPT_SSLKEY, "/data/wwwroot/mini3.pinecc.cn/extend/weixinpay/cert/");
