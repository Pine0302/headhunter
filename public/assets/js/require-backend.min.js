    ...
    var Table = {
        ...
        api: {
            ...
            multi: function (action, ids, table, element) {
                ...
                var url = typeof data.url !== "undefined" ? data.url : (action == "del" ? options.extend.del_url : (action == 'pass' ? options.extend.pass_url :(action == 'deny' ? options.extend.deny_url :  (action=='detail'  ? options.extend.detail_url : options.extend.multi_url ))));
