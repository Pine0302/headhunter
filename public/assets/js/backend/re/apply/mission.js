define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 're/apply/mission/index',
                    add_url: 're/apply/mission/add',
                    edit_url: 're/apply/mission/edit',
                    del_url: 're/apply/mission/del',
                    multi_url: 're/apply/mission/multi',
